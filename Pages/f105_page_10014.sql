...
/
prompt --application/pages/delete_10014
begin
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>10014);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18323397677149287)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18323490806149287)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(18323804948149287)
,p_name=>'Excepciones'
,p_parent_plug_id=>wwv_flow_api.id(18323490806149287)
,p_template=>wwv_flow_api.id(11242915532428353)
...
,p_ajax_enabled=>'Y'
,p_query_row_template=>wwv_flow_api.id(11280509869428385)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18330605331149324)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18331028741149326)
,p_query_column_id=>2
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18323909693149287)
,p_plug_name=>'&P10014_VALID_COUNT. Usuarios que Agregar'
,p_parent_plug_id=>wwv_flow_api.id(18323490806149287)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18324071995149287)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18334188943149346)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18334839242149348)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18324165642149287)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(18323397677149287)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18335509623149350)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18323397677149287)
,p_button_name=>'PREVIOUS'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(11319275654428435)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18323629367149287)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18336275195149351)
,p_name=>'P10014_ROLE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(18324071995149287)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_field_template=>wwv_flow_api.id(11318864613428433)
,p_lov_display_extra=>'NO'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18336622092149352)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18337035395149353)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(18323772187149287)
,p_name=>'Cancelar modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(18323629367149287)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18337774394149354)
,p_event_id=>wwv_flow_api.id(18323772187149287)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(18338225588149355)
...
,p_process_when_button_id=>wwv_flow_api.id(18324165642149287)
,p_process_success_message=>'Usuarios agregados.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(18338665215149356)
